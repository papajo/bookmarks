...
b2 = Book.create(title: "Unbroken", author: "Laura Hillenbrand", description: "An Olympic runners story of survival as a prisoner of the Japanese in World War II after his plane went down over the Pacific.", publisher: "Random House", weeks_on_list: 25, rank_this_week: 2)
...
b11 = Book.create(title: "The Client", author: "John Grishm", description: "A young lawyer takes aim at the war on drugs and its impact on black men.", publisher: "Middle Press", weeks_on_list: 98, rank_this_week: 1)
b12 = Book.create(title: "Eat Pray Love", author: "Some Chick", description: "A disgusting woman's journey.", publisher: "Nanana", weeks_on_list: 77, rank_this_week: 2)
...
Review.create(comment: "Revealing . . . Id recommend this to anyone", author: "USA Today", book_id: b9.id)
Review.create(comment: "Harriss journey of discovery brought back lessons for all of us about our lives, too.", author: "Diane Sawyer", book_id: b9.id)
...
Review.create(comment: "wow wow wow!.", author: "manama", book_id: b11.id)
Review.create(comment: "blah blah eat pray well.", author: "blah man", book_id: b12.id)